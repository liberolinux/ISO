...
install-libero:
	...
	@echo "Setting up improved Solarized Light terminal colors for admin mode..."

	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '# Improved Solarized Light terminal colors for admin mode' >> /root/.config/fish/config.fish"
	...
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    # Enhanced Solarized Light color palette with better contrast' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;0;#002b36\\007\"   # black (dark base)' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;1;#dc322f\\007\"   # red' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;2;#719e07\\007\"   # green (darker for better readability)' >> /root/.config/fish/config.fish"
	...
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;7;#93a1a1\\007\"   # white (readable gray)' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;8;#586e75\\007\"   # bright black' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;9;#cb4b16\\007\"   # bright red (orange)' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;10;#859900\\007\"  # bright green' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;11;#b58900\\007\"  # bright yellow' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;12;#268bd2\\007\"  # bright blue' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;13;#6c71c4\\007\"  # bright magenta (violet)' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;14;#2aa198\\007\"  # bright cyan' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;15;#fdf6e3\\007\"  # bright white (light background)' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    # Set foreground and background for optimal readability' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]10;#002b36\\007\"     # foreground (dark text)' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]11;#fdf6e3\\007\"     # background (light)' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    # Set fish colors for better visibility' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_cwd 002b36' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_command 268bd2' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_param 002b36' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_error dc322f' >> /root/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo 'end' >> /root/.config/fish/config.fish"

	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '# Improved Solarized Light terminal colors for admin mode' >> /home/libero/.config/fish/config.fish"
	...
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    # Enhanced Solarized Light color palette with better contrast' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;0;#002b36\\007\"   # black (dark base)' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;1;#dc322f\\007\"   # red' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;2;#719e07\\007\"   # green (darker for better readability)' >> /home/libero/.config/fish/config.fish"
	...
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;7;#93a1a1\\007\"   # white (readable gray)' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;8;#586e75\\007\"   # bright black' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;9;#cb4b16\\007\"   # bright red (orange)' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;10;#859900\\007\"  # bright green' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;11;#b58900\\007\"  # bright yellow' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;12;#268bd2\\007\"  # bright blue' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;13;#6c71c4\\007\"  # bright magenta (violet)' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;14;#2aa198\\007\"  # bright cyan' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]4;15;#fdf6e3\\007\"  # bright white (light background)' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    # Set foreground and background for optimal readability' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]10;#002b36\\007\"     # foreground (dark text)' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    printf \"\\033]11;#fdf6e3\\007\"     # background (light)' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    # Set fish colors for better visibility' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_cwd 002b36' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_command 268bd2' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_param 002b36' >> /home/libero/.config/fish/config.fish"
	sudo chroot $(CHROOT_DIR) /bin/bash -c "echo '    set -g fish_color_error dc322f' >> /home/libero/.config/fish/config.fish"
